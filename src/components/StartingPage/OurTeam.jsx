...
const OurTeam = () => {
  return (
    <section
      id="team"
      className="px-6 md:px-20 py-20 bg-white text-black flex flex-col items-center justify-center"
    >
      <motion.div
      ...
      {/* ✅ Centered Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 justify-items-center place-items-center">
